...
@Component({
  selector: 'app-blog-post-other',
  templateUrl: './blog-post-other.component.html',
  styleUrls: ['./blog-post-other.component.styl']
})
export class BlogPostOtherComponent implements OnInit {
